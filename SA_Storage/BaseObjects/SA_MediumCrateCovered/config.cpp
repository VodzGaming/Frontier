class CfgPatches
{
	class Abyss_CoveredMediumCrate
	{
		units[] = {"AbyssCoveredMediumCrate","Abyss_CoveredMediumCrate_Crate"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	class A6_Item;
	class A6_Kit;
	class SA_CoveredMediumCrate_Kit: A6_Kit
	{
		scope=2;
		weight=6500;
        ...
        hiddenSelectionsTextures[] = {"Spud_Stuff\SA_Storage\BaseObjects\SA_BaseKitBox\data\Storage_kit_MediumCrate.paa","Spud_Stuff\SA_Storage\BaseObjects\SA_BaseKitBox\data\Storage_kit_MediumCrate.paa"};
		descriptionShort = "Same capacity as the medium crate but fully enclosed to protect contents from dust and elements. 600 inventory. Perfect for field deployments. Can be disassembled with a screwdriver.";
		itemSize[] = {6,4};
	};    
    class A6_Storage_Base;
	class SA_CoveredMediumCrate: A6_Storage_Base
    {
        scope = 2;
        displayName = "A.L.S. Medium Crate";
        descriptionShort = "Same capacity as the medium crate but fully enclosed to protect contents from dust and elements. 600 inventory. Perfect for field deployments. Can be disassembled with a screwdriver.";
        model = "Spud_Stuff\SA_Storage\BaseObjects\SA_MediumCrateCovered\CoveredMediumCrate.p3d";
        rotationFlags = 2;
        itemBehaviour = 0;
